...
class ResultReportController extends Controller
{
    public function ResultView(){
    	...
    	return view('admin.report.student_result.student_result_view',$data);
    ...
    public function ResultGet(Request $request){
        ...
        $pdf = PDF::loadView('admin.report.student_result.student_result_pdf', $data);
    ...
    public function IdcardView(){
    	$data['years'] = StudentYear::all();
    	$data['classes'] = StudentClass::all();
    	return view('admin.report.idcard.idcard_view',$data);
    }
    ...
    $pdf = PDF::loadView('admin.report.idcard.idcard_pdf', $data);
	$pdf->SetProtection(['copy', 'print'], '', 'pass');
	return $pdf->stream('document.pdf');
