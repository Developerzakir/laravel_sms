...
class EmployeeSalaryController extends Controller
{
    public function SalaryView()
    {
    	...
    	return view('admin.employee.employee_salary.employee_salary_view',$data);
    }
    ...
    public function SalaryIncrement($id)
    {
    	...
    	return view('admin.employee.employee_salary.employee_salary_increment',$data);
    ...
    public function SalaryStore(Request $request, $id)
    {
    	...
    	return redirect()->route('employee.sallary.view')->with($notification);
    ...
    public function SalaryDetails($id)
    {
    	...
    	return view('admin.employee.employee_salary.employee_salary_details',$data);
