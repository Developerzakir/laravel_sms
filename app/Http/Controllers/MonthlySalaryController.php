...
class MonthlySalaryController extends Controller
{
    public function MonthlySalaryView(){
    	return view('admin.employee.monthly_salary.monthly_salary_view');
  ...
  public function MonthlySalaryGet(Request $request){
    	 ...
    	 foreach ($data as $key => $attend) {
    	 	...
    	 	//total salary count with calculate absent
    ...
    $pdf = PDF::loadView('admin.employee.monthly_salary.monthly_salary_pdf', $data);
