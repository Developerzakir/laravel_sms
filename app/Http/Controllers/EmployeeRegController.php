...
class EmployeeRegController extends Controller
{
    ...
    public function EmployeeView()
    {
    	...
    	return view('admin.employee.employee_reg.employee_view',$data);
    }


    public function EmployeeAdd(){
    	$data['designation'] = Designation::all();
    	return view('admin.employee.employee_reg.employee_add',$data);
    }
    ...
    public function EmployeeEdit($id){
    	...
    	$data['designation'] = Designation::all();
    	return view('admin.employee.employee_reg.employee_edit',$data);
