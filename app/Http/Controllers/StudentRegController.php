...
class StudentRegController extends Controller
{
    public function StudentRegView()
    {
        ...
        $data['search'] = false;
    	return view('admin.student.student_reg.student_view',$data);
    }
    ...
    public function StudentRegAdd()
    {
    	...
    	return view('admin.student.student_reg.student_add',$data);
    }
    ...
    public function StudentRegEdit($student_id){
    	...
    	return view('admin.student.student_reg.student_edit',$data);
 ...
 public function StudentRegUpdate(Request $request,$student_id){
    ...
    // 	return view('admin.student.student_reg.student_promotion',$data);
